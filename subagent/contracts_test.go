...
func validDevelopmentPlan() *DevelopmentPlan {
	return &DevelopmentPlan{
		...
		Steps: []PlanStep{{
			...
			Verification: []string{"safe-test ./subagent"},
		}},
...
func TestParseDevelopmentPlanRejectsUnknownFields(t *testing.T) {
	raw := `{"goal":"g","assumptions":[],"files":["a.go"],"steps":[{"id":"step-1","objective":"o","allowed_files":["a.go"],"acceptance":["a"],"verification":[]}],"risks":[],"final_verification":["safe-test"],"unexpected":true}`
