...
12. JSONL 로그에는 raw supplied inputs, raw resolved arguments, image/audio/base64 payloads, unrestricted results를 기록하지 않는다. 필드명, 크기, 유용한 hash, bounded summary/error만 기록하며 비밀값 저장 기능은 v0.1에 도입하지 않는다.
